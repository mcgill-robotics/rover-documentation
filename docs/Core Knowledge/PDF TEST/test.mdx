...
<iframe src="@site/static/pdfs/Jetson Orin Nano Developer Kit Carrier Board Specification.pdf" width="100%" height="600px">
  This browser does not support PDFs. Please download the PDF to view it: 
  <a href="@site/static/pdfs/Jetson Orin Nano Developer Kit Carrier Board Specification.pdf">Download PDF</a>.
</iframe>

[View PDF](@site/static/pdfs/Jetson Orin Nano Developer Kit Carrier Board Specification.pdf)
