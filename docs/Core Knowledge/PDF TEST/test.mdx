...
<object data="https://www.st.com/resource/en/datasheet/vnh5019a-e.pdf" type="application/pdf" width="700px" height="700px">
    <embed src="https://www.st.com/resource/en/datasheet/vnh5019a-e.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="https://www.st.com/resource/en/datasheet/vnh5019a-e.pdf">Download PDF</a>.</p>
    </embed>
</object>
