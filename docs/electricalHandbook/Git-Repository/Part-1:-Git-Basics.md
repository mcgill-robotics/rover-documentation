...
1. Go to our repo on Github and go to the Pull requests page.![](Part-1:-Git-Basics-img/image1.png)  
2. Press on New pull request![](Part-1:-Git-Basics-img/image2.png)  
3. Press on the compare button and select your branch in the drop down.![](Part-1:-Git-Basics-img/image3.png)  
4. Click on Create pull request![](Part-1:-Git-Basics-img/image4.png)  
5. Add a descriptive name and a more detailed description of what the pull request changes in the repo then press the Create pull request button. ![](Part-1:-Git-Basics-img/image5.png)  
